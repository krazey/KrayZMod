...
if (_argc >1) then {
    ...
    switch (_grouptype) do
    {
        case 1: // military
        {
            ...
            _initstring = format["null = [this,%1] execVM '\dayz_krayz\addons\SARGE\SAR_trace_from_vehicle.sqf';this setIdentity 'id_SAR_sold_man';",_tracewhat];
        ...
        case 2: // survivors
        {
            ...
            _tracewhat = ['CAManBase'];
            _initstring = format["null = [this,%1] execVM '\dayz_krayz\addons\SARGE\SAR_trace_from_vehicle.sqf';this setIdentity 'id_SAR_surv_lead';",_tracewhat];
        ...
        case 3: // bandits
        {
            ...
            _tracewhat=['CAManBase'];
            _initstring = format["null = [this,%1] execVM '\dayz_krayz\addons\SARGE\SAR_trace_from_vehicle.sqf';this setIdentity 'id_SAR_band';",_tracewhat];
...
//_heli addEventHandler ["HandleDamage", {returnvalue = _this execVM "\dayz_krayz\addons\SARGE\SAR_ai_vehicle_hit.sqf";}];  
_heli addMPEventHandler ["MPHit", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aihit.sqf";}];  
...
_leaderheli addMPEventHandler ["MPkilled", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aikilled.sqf";}];
_leaderheli addMPEventHandler ["MPHit", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aihit.sqf";}];  
...
_man2heli addMPEventHandler ["MPkilled", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aikilled.sqf";}];
_man2heli addMPEventHandler ["MPHit", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aihit.sqf";}];  
...
_man3heli addMPEventHandler ["MPkilled", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aikilled.sqf";}];
_man3heli addMPEventHandler ["MPHit", {Null = _this execVM "\dayz_krayz\addons\SARGE\SAR_aihit.sqf";}];  
...
_ups_para_list execVM '\dayz_krayz\addons\UPSMON\scripts\upsmon.sqf';

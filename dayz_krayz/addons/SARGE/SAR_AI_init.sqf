...
SAR_AI_trace                      = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_trace_entities.sqf";
SAR_AI_trace_veh                  = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_trace_from_vehicle.sqf";
SAR_AI_hit                        = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_aihit.sqf";
...
call compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_functions.sqf";


// preprocessing relevant serverside scripts
SAR_AI                      = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_setup_AI_patrol.sqf";
SAR_AI_heli                 = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_setup_AI_patrol_heli.sqf";
SAR_AI_land                 = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_setup_AI_patrol_land.sqf";
SAR_AI_reammo               = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_reammo_refuel_AI.sqf";
SAR_AI_spawn                = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_AI_spawn.sqf";
SAR_AI_despawn              = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_AI_despawn.sqf";
SAR_AI_killed               = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_aikilled.sqf";
SAR_AI_UPSMON               = compile preprocessFileLineNumbers "\dayz_krayz\addons\UPSMON\scripts\upsmon.sqf";
SAR_AI_VEH_HIT              = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_ai_vehicle_hit.sqf";
SAR_AI_GROUP_MONITOR        = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_group_monitor.sqf";
SAR_AI_VEH_FIX              = compile preprocessFileLineNumbers "\dayz_krayz\addons\SARGE\SAR_vehicle_fix.sqf";

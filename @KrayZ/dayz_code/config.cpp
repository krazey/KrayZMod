...
class HeliCrash_No50s: Default {
	...
	class Military: Default {
		...
		itemChance[] =	{
			//r3f armes weaponary
			0.05, //"R3F_Famas_F1",
			0.02, //"R3F_Famas_F1_AIM",
			0.02, //"R3F_Famas_F1_EOT",
			0.05, //"R3F_Famas_G2",
			0.02, //"R3F_Famas_G2_EOT",
			0.02, //"R3F_Famas_G2_J4",
			0.02, //"R3F_Famas_G2_J4_HG",
			0.02, //"R3F_Famas_G2_AIM_HG",
			0.02, //"R3F_Famas_G2_AIM_M203",
			0.02, //"R3F_Famas_surb_AIM_HG",
			0.02, //"R3F_Famas_surb",
			0.02, //"R3F_Famas_surb_EOT_M203",
			0.02, //"R3F_HK417L_NF",
			0.05, //"R3F_HK417M_AIM",
			0.02, //"R3F_HK417S_EOT_HG",
			0.02, //"R3F_HK417S_HG_SD",
			0.02, //"R3F_FRF2_J8",
			0.02, //"R3F_FRF2_J8_SD",
	...
	class MilitarySpecial: Default {
		...
		itemChance[] =	{
			...
			0.002, //"R3F_PGM_Hecate_II _MILDOT_DES",

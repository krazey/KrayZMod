...
if (_isFireNear >= 1 and _canDo) then {
	...
	_selectedRecipeOutput = getArray (configFile >> "cfgMagazines" >> _this >> "ItemActions" >> "Crafting3" >> "output");
	_selectedRecipeInput = getArray (configFile >> "cfgMagazines" >> _this >> "ItemActions" >> "Crafting3" >> "input");

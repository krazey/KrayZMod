...
call compile preprocessFile "\dayz_krayz\addons\R3F_Realism\R3F_Tired\R3F_Tired_Fnct.sqf";
...
_void = [] execVM "\dayz_krayz\addons\R3F_Realism\R3F_Tired\R3F_DoTired.sqf";
...
if(safezonebuild) exitWith { cutText ["You can not place Vaults in a safezone." , "PLAIN DOWN"]; };
if(citybuild) exitWith { cutText ["You can not place Vaults in a Village or City." , "PLAIN DOWN"]; };
